...
describe User do
	...
	before { @user = User.new(name: "Example User", email: "user@example.com", phone: "123-456-7890", password: "foobar", password_confirmation: "foobar") }
	...
	describe "when phone format is invalid" do
		it "should be invalid" do
			numbers = %w[1234567890 (123)456-7890 123456-7890 111-111-11111]
	...
	describe "when phone format is valid" do
		it "should be valid" do
			numbers = %w[123-456-7890 234-567-8901 111-111-1111]
